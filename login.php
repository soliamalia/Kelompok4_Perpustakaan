...
<!--[if gt IE 8]><!--> <html class="no-js" > <!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>SSMAN 2 Bandung Library</title>
	...
	<body>
		...
		<div class="wrapper">
			...
			<!-- HEADER -->
			<header class="cf">
				<div id="logo"><img src="<?php echo base_url();?>img/sman2.png" height="130" width="130"></a></div>
			</header>
			<!-- ENDS HEADER -->
			...
			<nav class="cf">
				<ul id="nav" class="sf-menu">
					...
					<li class="current-menu-item"><a href="<?php echo base_url();?>index.php/clogin/login">LOG IN</a></li>
